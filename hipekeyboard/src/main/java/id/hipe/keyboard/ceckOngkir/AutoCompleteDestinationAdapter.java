 ...
 * on 17/05/18.
 */
public class AutoCompleteDestinationAdapter extends RecyclerView.Adapter<AutoCompleteDestinationAdapter.ViewHolder> {

    private Context context;
    private List<Lokasi> lokasiList;
    private AutoCompleteCallback callback;

    public AutoCompleteDestinationAdapter(Context context, List<Lokasi> lokasiList) {
    ...
    public interface AutoCompleteCallback {
        void onClickItemDestination(Lokasi lokasi);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onClickItem() {
            callback.onClickItemDestination(lokasiList.get(getAdapterPosition()));
        }
